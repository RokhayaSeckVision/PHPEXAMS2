...
<div class="titre">Générer un rapport sur un client</div>
<form action="" method="POST" class="formulaire">
    <fieldset >
        
        <input type="number" name="id_client"placeholder="ID Client" required><br>
        
        <button type="submit" name="modifier">Générer un rapport</button>
